...
This skill enables AI agents to search for jobs across multiple job boards using the **JobSpy MCP Server**. JobSpy aggregates job listings from LinkedIn, Indeed, Glassdoor, ZipRecruiter, Google Jobs, Bayt, Naukri, Stepstone, and Xing into a unified interface.
...
- `stepstone` - Leading European job board (Germany/DACH)
...
```json
{
  "sites": [
    {
      "name": "indeed",
      "description": "Largest job search engine, most reliable"
    },
    {
      "name": "linkedin",
      "description": "Professional networking platform, rate limited"
    },
    {
      "name": "glassdoor",
    ...
    {
      "name": "stepstone",
      "description": "Leading European job board (Germany/DACH)"
    },
    { "name": "xing", "description": "German professional networking platform" }
  ]
}
```
