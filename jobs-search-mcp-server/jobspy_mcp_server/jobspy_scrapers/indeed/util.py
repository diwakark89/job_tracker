from jobspy_mcp_server.jobspy_scrapers.model import CompensationInterval, JobType, Compensation
from jobspy_mcp_server.jobspy_scrapers.util import get_enum_from_job_type
