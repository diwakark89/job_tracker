...
from jobspy_mcp_server.jobspy_scrapers.exception import NaukriException
from jobspy_mcp_server.jobspy_scrapers.naukri.constant import headers as naukri_headers
from jobspy_mcp_server.jobspy_scrapers.naukri.util import (
    is_job_remote,
    parse_job_type,
